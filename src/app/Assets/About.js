  ...
  return (
    <div className=' h-screen w-full'>
        ...
        <div className='About-outer h-5/6 w-auto md:flex md:items-center'>
            <div className='About-img flex flex-col w-full px-5 h-fit'>
                <Image src={AboutPic} alt='profilepic-2' className='size-[280px] sm:size-[280px] lg:size-[320px] xl:size-[480px] 2xl:size-[600px] m-[10px] self-center rounded-3xl'></Image>
            </div>
            <div className='About-content gap-5 sm:gap-0 flex flex-col  w-[100%] h-fit md:p-10'>
                ...
                <p className='text-black sm:text-xs lg:text-sm xl:text-xl 2xl:text-4xl w-[100%] px-3 sm:p-5 text-center'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
            </div>
        </div>
    </div>
  )
