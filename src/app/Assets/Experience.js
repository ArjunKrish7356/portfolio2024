  ...
  return (
    <div className='  h-fit sm:h-[100vh] w-full flex flex-col items-center text-black'>
       <div className='  title flex flex-col gap-1 sm:gap-0 w-full p-5'>
         ...
         <div className=' h-fit flex flex-col sm:flex-row sm:justify-evenly sm:items-end w-full p-5 gap-3'>
         <div className=' h-fit sm:h-[70vh] sm:w-fit p-[2%]  border border-black rounded-xl  flex flex-col items-center'>
            <h1 className=' text-xl font-semibold pb-[5%] lg:pb-[10%] sm:text-base lg:text-2xl xl:text-3xl'>Frontend Development</h1>
            <div className='sm:grid grid-rows-3 grid-cols-2 gap-5 md:gap-10 lg:gap-16 flex flex-col justify-evenly h-[70%]'>
